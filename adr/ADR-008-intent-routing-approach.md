...
The Chat Service must quickly decide whether a user message can be handled by a simple, deterministic tool path or whether it requires the full agentic LLM + tools loop. Alternatives considered:
