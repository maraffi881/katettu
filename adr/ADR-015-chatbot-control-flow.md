...
Both paths are protected by the input and output guardrails defined in ADR-010. Rich context (itinerary, zone, etc.) is injected on every request (see ADR-009).
